...
/**
 * Defines the possible states of a TripBooking. Using an enum for trip status
 * provides type safety and makes the code more readable and maintainable
 * compared to using simple strings or integers.
 */
