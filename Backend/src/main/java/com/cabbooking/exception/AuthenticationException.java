 ...
 * or authentication fails due to other reasons.
 * 
 * Extends RuntimeException to allow unchecked propagation.
 * 
 * Usage:
 * - Thrown by authentication-related services, e.g., during login.
 * - Caught by global exception handlers to return appropriate HTTP error responses.
 */
