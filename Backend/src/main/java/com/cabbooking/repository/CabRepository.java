 ...
 * Delete) operations for the Cab table. - Enables the service layer to interact
 * with the database for all cab-related data.
 *
 * Workflow: - This interface is used by services like `CabServiceImpl` and
 * `TripBookingServiceImpl` to manage the fleet of cabs and find available
 * vehicles for trips.
 */
