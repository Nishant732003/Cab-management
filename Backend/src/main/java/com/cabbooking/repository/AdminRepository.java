 ...
 * for Admin entities with Integer as the primary key type.
 *
 * Additional custom database query methods related to Admin can be declared
 * here.
 *
 * This repository permits searching Admin entities by username, which is
 * essential for authentication and other admin-specific queries.
 */
